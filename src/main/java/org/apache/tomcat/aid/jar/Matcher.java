...
public final class Matcher {
	...
	/**
	 * Tests whether or not a given path matches any pattern in the given set. If you need to call
	 * this method multiple times with the same pattern you should rather pre parse the pattern using
	 * tokenizePathAsArray.
	 * 
	 ...
	 * @return <code>true</code> if any pattern in the set matches against the string, or
	...
	/**
	 * Tests whether or not a given path matches a given pattern. If you need to call this method
	 * multiple times with the same pattern you should rather pre parse the pattern using
	 * tokenizePathAsArray.
	 * 
	 * @see #tokenizePathAsArray
	...
	/**
	 * Breaks a path up into a array of path elements, tokenizing on <code>File.separator</code>.
	 * 
	 ...
	 * separator--signifying a Windows UNC--must at minimum match "\\a\b" to be considered an
	 * absolute path.
	 * 
